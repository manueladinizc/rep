...
public class PagamentoController {
    ...
    public ResponseEntity<Pagamento> buscarPagamentosPeloId(@PathVariable Integer idPagamento){
        Pagamento pagamento = pagamentoService.buscarPagamentosPeloId(idPagamento);
    ...
    public ResponseEntity<Pagamento> cadastrarUmPagamento(@PathVariable Integer idChamado,
                                                         @RequestBody Pagamento pagamento){

        pagamento = pagamentoService.cadastrarUmPagamento(pagamento, idChamado);
        URI novaUri =
                ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(pagamento.getIdPagamento()).toUri();
    ...
    public ResponseEntity<Pagamento> modificarStatusPagamento(@PathVariable Integer idPagamento, @RequestParam(
